...
- 5장 · 방 10개 · 두 갈래 결말. 결말 뒤에는 「사건의 전말」 — 그림들을 한 줄로 이어 붙인 파노라마 위로, 흩어져 있던 단서가 시간 순서대로 이어진다. 1시간 안팎.
...
| 10 등대 꼭대기 | 도현 | 성냥갑 속 필름을 렌즈 틀의 필름 위에 1도 단위로 맞추면 「아빠는 살아 있어 / 배에서 기다려 / — ㄷㅎ」. 서명 ㄷㅎ는 5방 사진 뒷면의 도현 서명과 같다 → 쓴 사람은 도현, 스스로를 「아빠」라 부른다 → 반쪽을 가졌던 서연은 딸 |
